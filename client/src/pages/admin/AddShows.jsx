   ...
   useEffect(()=>{
    ...
    <div className='overflow-x-auto pb-4'>
     <div className='group flex flex-wrap gap-4 mt-4 w-max'>
                    ...
                    <img src={image_base_url+movie.poster_path} alt="" className='w-full object-cover brightness-90'/>
                     <div className='text-sm flex items-center justify-between p-2 bg-black/70 w-full absolute bottom-0 left-0'>
                      ...
                      <p className='text-gray-300'>
                        {kConverter(movie.vote_count)} Reviews
                      </p>
                      </div>
      ...
      <div className='mt-2'>
          <p className='font-medium text-sm truncate' title={movie.title}>
              {movie.title}
          </p>
    ...
    <div className='mt-6'>
      ...
      <div className='flex gap-3 border border-gray-600 p-2 rounded-lg items-center'>
        <input ref={inputRef} type="datetime-local" value={dateTimeInput} onChange={(e)=>setDateTimeInput(e.target.value)}  onClick={() => inputRef.current?.showPicker()} className='outline-none rounded-md'/>
