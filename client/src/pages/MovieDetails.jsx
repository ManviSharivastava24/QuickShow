...
function MovieDetails() {
  ...
  const handleFavorite=async()=>{
    try {
      if(!user) return toast.error("Please login to password");
...
<div className='flex justify-center mt-20'>
  <button onClick={()=> navigate('/movies')} className='px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-md fonr-medium cursor-pointer '>
    Show More
  </button>
